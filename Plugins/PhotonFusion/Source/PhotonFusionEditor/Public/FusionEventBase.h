...
//#include "FusionEventBase.generated.h"
...
//
// UCLASS(MinimalAPI)
// class UFusionEventBase : public UK2Node_Event
// {
...
// 	void RenameCustomEventCloseToName(int32 StartIndex = 1);
//
// 	static UFusionEventBase* CreateFromFunction(FVector2D GraphPosition, UEdGraph* ParentGraph, const FString& Name, const UFunction* Function, bool bSelectNewNode = true);
//
// 	/**
...
// 	*/
// 	void SetDelegateSignature(const UFunction* DelegateSignature);
//
// private:
...
class FFusionEventBaseDetails : public IDetailCustomization
{
public:
