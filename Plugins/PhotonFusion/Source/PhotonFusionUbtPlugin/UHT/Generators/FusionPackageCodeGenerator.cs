...
{
	public class FusionPackageCodeGenerator
	{
		...
		public readonly FusionUhtCodeGen CodeGenerator;
		...
		public bool SaveExportedHeaders
		{
			...
			{
				#if UE_5_5_OR_LATER
				return HeaderFile.Module.Module.SaveExportedHeaders;
				#else
				return HeaderFile.Package.Module.SaveExportedHeaders;
				#endif
			}
		}

		public UhtSession Session => CodeGenerator.Session;
		public FusionUhtCodeGen.PackageInfo[] PackageInfos => CodeGenerator.PackageInfos;
		public FusionUhtCodeGen.HeaderInfo[] HeaderInfos => CodeGenerator.HeaderInfos;
		public FusionUhtCodeGen.ObjectInfo[] ObjectInfos => CodeGenerator.ObjectInfos;

		public FusionPackageCodeGenerator(FusionUhtCodeGen codeGenerator, UhtHeaderFile headerFile)
		{
	...
	public static class UhtPackageCodeGeneratorExtensions
	{
		...
		// 		AppendMetaDataDecl(builder, type, null, name, null, null, tabs);
