...
{
	static class FusionStringBuilderExtensions
	{
		/// <summary>
		...
		public static StringBuilder AppendMacroName(this StringBuilder builder, FusionHeaderCodeGeneratorHFile generator, int lineNumber, string macroSuffix)
		{
			return builder.AppendMacroName(generator.FileId, lineNumber, macroSuffix);
		}

		public static StringBuilder AppendMacroName(this StringBuilder builder, FusionHeaderCodeGeneratorHFile generator, UhtClass classObj, string macroSuffix)
		{
			return builder.AppendMacroName(generator, classObj.GeneratedBodyLineNumber, macroSuffix);
		}

		public static StringBuilder AppendMacroName(this StringBuilder builder, FusionHeaderCodeGeneratorHFile generator, UhtScriptStruct scriptStruct, string macroSuffix)
		{
			return builder.AppendMacroName(generator, scriptStruct.MacroDeclaredLineNumber, macroSuffix);
		}

		public static StringBuilder AppendMacroName(this StringBuilder builder, FusionHeaderCodeGeneratorHFile generator, UhtFunction function, string macroSuffix)
		{
